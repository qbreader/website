...
fetch('/api/geoword/paid/play/division-choice?' + new URLSearchParams({ packetName }))
...
document.getElementById('form').addEventListener('submit', event => {
  ...
  fetch('/api/geoword/paid/results/compare?' + new URLSearchParams({ packetName, division, opponent }))
    .then(response => response.json())
    .then(data => {
