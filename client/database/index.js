...
const ALTERNATE_SUBCATEGORY_BUTTONS = [['Drama', 'primary'], ['Poetry', 'primary'], ['Long Fiction', 'primary'], ['Short Fiction', 'primary'], ['Math', 'danger'], ['Astronomy', 'danger'], ['Computer Science', 'danger'], ['Earth Science', 'danger'], ['Engineering', 'danger'], ['Misc Science', 'danger'], ['Architecture', 'warning'], ['Dance', 'warning'], ['Film', 'warning'], ['Jazz', 'warning'], ['Opera', 'warning'], ['Photography', 'warning'], ['Misc Arts', 'warning']];
let validCategories = [];
