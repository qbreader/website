import questionStats from"../scripts/auth/question-stats.js";import api from"../scripts/api/index.js";import audio from"../audio/index.js";import CategoryManager from"../../quizbowl/category-manager.js";import{getDropdownValues}from"../scripts/utilities/dropdown-checklist.js";import{arrayToRange,rangeToArray}from"../scripts/utilities/index.js";import createTossupGameCard from"../scripts/utilities/tossup-game-card.js";import CategoryModal from"../scripts/components/CategoryModal.min.js";import DifficultyDropdown from"../scripts/components/DifficultyDropdown.min.js";import upsertPlayerItem from"../scripts/upsertPlayerItem.js";import{MODE_ENUM}from"../../quizbowl/constants.js";const categoryManager=new CategoryManager;let oldCategories=JSON.stringify(categoryManager.export());const room={difficulties:[],mode:MODE_ENUM.RANDOM,muteList:[],ownerId:"",public:!0,setLength:24,showingOffline:!1},players={},ROOM_NAME=decodeURIComponent(window.location.pathname.substring(13));/**
