...
const createBonusCard = (function () {
    ...
    return function (bonus) {
        ...
        document.getElementById('star-bonus-' + questionCounter).addEventListener('click', function (event) {
...
const createTossupCard = (function () {
    ...
    return function (tossup) {
        ...
        document.getElementById('star-tossup-' + questionCounter).addEventListener('click', function (event) {
            event.preventDefault();
            event.stopPropagation();
